...
describe("calendar.test.js", () => {
  ...
  it("returns correct calendar", () => {
    ...
    expect(calendar.weeks[4].days[6]).toEqual({
      date: new Date("2017-12-31T00:00:00.000Z"),
      week: 52
    });

    const calendar2 = calendarHelper.getCalendar(41, 2016);
    expect(calendar2.weeks[0].days[0]).toEqual({
      date: new Date("2016-09-26T00:00:00.000Z"),
      inPast: true,
      week: 39
    });
    expect(calendar2.weeks[5].days[6]).toEqual({
